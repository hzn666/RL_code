...
class SACAgent:
    ...
    def _log(self,
        ...
        self.writer.add_scalar('vf_loss', vf_loss, global_step=frame_idx)
        ...
        print(
            "frame: {} | Score: {} | ActorLoss: {} | qfLoss: {} | vfLoss: {} | alphaLoss: {}".format(frame_idx, score,
                                                                                                     actor_loss,
                                                                                                     qf_loss,
                                                                                                     vf_loss,
                                                                                                     alpha_loss))

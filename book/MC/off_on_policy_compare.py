...
def play(env, num_episodes, discount_factor=1.0, epsilon=0.1):
    ...
    for i_episode in range(1, num_episodes + 1):
        ...
        # 在线策略
        Q_on, policy, returns_sum, returns_count, episode_on = on_policy(state, Q_on, discount_factor, returns_sum,
                                                                         returns_count, episode_on, policy)

        # 离线策略
        Q_off, target_policy, C, episode_off = off_policy(state, random_policy, episode_off, discount_factor,
                                                          target_policy, C, Q_off)
